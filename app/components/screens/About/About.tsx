...
const About: FC = () => (
	<Meta title='О нас'>
		<WrapperContent>
			<Heading small title='О НАС' />
			<SubHeading>Наша миссия и ценности!</SubHeading>
			<p className={styles.description}>
				Онлайн-курс адресован всем, кто интересуется индивидуальными различиями – сильными и слабыми
				сторонами личности, вопросами совместимости людей с разными особенностями. Бывает ли
